...
The Elves just need to know __which crate will end up on top of each stack__; in this example, the top crates are C in stack 1, M in stack 2, and Z in stack 3, so you should combine these together and give the Elves the message __CMZ__.
...
In this example, the CrateMover 9001 has put the crates in a totally different order: __MCD__.
